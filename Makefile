...
ACLOCAL = ${SHELL} /v/filer4b/v38q001/agarza/cs354r-assignment4/missing --run aclocal-1.11
AMTAR = $${TAR-tar}
AR = ar
AUTOCONF = ${SHELL} /v/filer4b/v38q001/agarza/cs354r-assignment4/missing --run autoconf
AUTOHEADER = ${SHELL} /v/filer4b/v38q001/agarza/cs354r-assignment4/missing --run autoheader
AUTOMAKE = ${SHELL} /v/filer4b/v38q001/agarza/cs354r-assignment4/missing --run automake-1.11
AWK = gawk
BULLET_CFLAGS = 
BULLET_LIBS = 
CC = gcc
...
LN_S = ln -s
LTLIBOBJS = 
MAKEINFO = ${SHELL} /v/filer4b/v38q001/agarza/cs354r-assignment4/missing --run makeinfo
MANIFEST_TOOL = :
MKDIR_P = /bin/mkdir -p
NM = /usr/bin/nm -B
NMEDIT = 
...
STRIP = strip
VERSION = 0.1
abs_builddir = /v/filer4b/v38q001/agarza/cs354r-assignment4
abs_srcdir = /v/filer4b/v38q001/agarza/cs354r-assignment4
abs_top_builddir = /v/filer4b/v38q001/agarza/cs354r-assignment4
abs_top_srcdir = /v/filer4b/v38q001/agarza/cs354r-assignment4
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /v/filer4b/v38q001/agarza/cs354r-assignment4/install-sh
